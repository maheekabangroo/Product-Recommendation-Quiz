#WITH GUI - WITH ALL VALUES AS CSV DATASETS
...
def predict():
    ...
    if final_stage in recommendations_dict:
        result_label.config(text=f"Based on your answers, you are recommended:\n{recommendations_dict[final_stage]}")
    else:
        result_label.config(text="No recommendation found for the predicted stage.")
